...
<main id="js-page-content" role="main" class="page-content mt-3">
    ...
    <form action="./dataPHP/edit_login_data.php?id=<?php echo $_GET['id']; ?>" method="post">
        <div class="row">
            <div class="col-xl-6">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <input name="email" type="text" id="simpleinput" class="form-control"
                                       value="<?php echo getUserField($_GET['id'], 'email') ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="verify_password" type="password" id="simpleinput" class="form-control">
                            </div>
