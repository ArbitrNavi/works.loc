        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            <div class="subheader">
                <h1 class="subheader-title">
                    <i class='subheader-icon fal fa-user'></i> <?php echo getUserField($currentID, 'name') ?>
                </h1>
            </div>
            <div class="row">
                            ...
                            <div class="col-12">
                                <div class="d-flex flex-column align-items-center justify-content-center p-4">
                                    ...
                                    <div class="mt-4 text-center demo">
                                        ...
                                        <a href="<?php echo getUserField($currentID, 'vk') ?>" class="fs-xl" style="color:#4680C2">
                                            <i class="fab fa-vk"></i>
                                        </a>
                                        <a href="<?php echo getUserField($currentID, 'telegram') ?>" class="fs-xl" style="color:#0088cc">
