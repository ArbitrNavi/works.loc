            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                $user_data = [
                    [
                        ...
                        "work" => "IT Director, Gotbootstrap Inc",
                    ...
                    [
                        ...
                        "work" => "Project Manager, Gotbootstrap Inc",
                    ...
                    [
                        ...
                        "work" => "Human Resources, Gotbootstrap Inc",
                    ...
                    [
                        ...
                        "work" => "Staff Orgnizer, Gotbootstrap Inc",
                    ...
                    [
                        ...
                        "work" => "Oncologist, Gotbootstrap Inc",
                    ...
                    [
                        ...
                        "work" => "Xray Division, Gotbootstrap Inc",
                    ...
                    [
                        ...
                        "work" => "Accounting, Gotbootstrap Inc",
                ...
                ?>
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $data["filter"]; ?>">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status <?php echo $data["status"]; ?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $data["avatar"] ?>'); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    ...
                                    <span class="text-truncate text-truncate-xl"><?php echo $data["work"]; ?>.</span>
                                </div>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i><?php echo $data["phoneNumber"]; ?></a>
                                <a href="mailto:<?php echo $data["mail"]; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i><?php echo $data["mail"]; ?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i><?php echo $data["addres"] ?></address>
