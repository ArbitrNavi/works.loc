                    ...
                    foreach ($user_data as $data) {
                        ?>
                            <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                <img src="<?php echo $data["avatar"]; ?>" alt="<?php echo $data["name"]; ?>"
                                ...
                                <div class="ml-2 mr-3">
                                    ...
                                    <a href="<?php echo $data["social"] ?>" class="text-info fs-sm"
                                       target="_blank"><?php echo $data["social_title"] ?></a> - <a
                                            href="https://wrapbootstrap.com/user/myorange" class="text-info fs-sm"
