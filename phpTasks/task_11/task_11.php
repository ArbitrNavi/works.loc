                        ...
                        <div class="form-group">
                            ...
                            if (isset($_SESSION['text'])) { ?>
                                <div class="alert alert-danger fade show" role="alert">
                                    Значение уже присутствует в таблице
                                </div>
                            ...
                            <form action="data.php" method="post">
                                ...
                                <input type="text" name="email" id="simpleinput1" class="form-control">
                                <button class="btn btn-success mt-3" action="submit">Submit</button>
                            </form>
                        </div>
                        <div style="">
                            <?php
